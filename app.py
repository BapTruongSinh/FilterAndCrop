...
CONFIG_PATH = Path(__file__).resolve().with_name("last_paths.json")
...
class FilterAndCropApp:
    def __init__(self) -> None:
        """Khởi tạo cửa sổ chính, trạng thái xử lý ảnh và nạp cấu hình cũ."""
        self.root = tk.Tk()
    ...
    def load_config(self) -> None:
        """Đọc file cấu hình local để khôi phục các đường dẫn đã dùng lần trước."""
    ...
    def save_config(self) -> None:
        """Lưu các đường dẫn hiện tại vào file cấu hình local."""
